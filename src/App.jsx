    ...
    <>
      ...
      <div className='bg-[#CCCCCC] px-5  py-8 xl:py-[70px] '>
        <div className='xl:ml-[85px]'>
          <div className='flex gap-4 md: items-center justify-center md:justify-start   md:ml-[90px]  lg:ml-[210px]'>
          ...
          <p className=' md:mx-[190px] lg:ml-[210px] text-base md:text-xl lg:text-2xl    lg:py-10 md:py-3  text-[#00354E] font-normal leading-6 md:leading-[30px] lg:leading-[42px] max-w-[1240px]'>
      ...
      <div>
        <div className='flex flex-col md:hidden w-full  lg:h-[596px] py-8 px-6  lg:flex  lg:flex-row gap-16 justify-around items-center '>
          <div className='order-2 lg:order-1 xl:w-[610px] mx-10'>
      ...
      <div className=' hidden md:flex justify-center 2xl:hidden'>
        <div className='relative rounded-[28px]'>
          ...
          <div className=' flex flex-col justify-center px-10 gap-6  absolute inset-0 text-white '>
      ...
      <div className=' flex flex-col md:flex-row  gap- lg:gap-52 items-center justify-around py-10'>
        <div className=' md:w-[575px] px-5  '>
          <div className='flex justify-center'>
            <img src="./assets/award.jpeg" alt="award" className=' w-[323px] h-[266px] md:w-[558px] md:h-[344px]  object-cover rounded-[10px] ' />
          </div>
          <h4 className='text-xl md:text-5xl font-bold text-[#003A3A] mt-10 '>VÅRT MOTTO</h4>
      ...
      <div className=' py-10  px-5 '>
        <h1 className=' roboto-bold  text-4xl lg:text-5xl px-[177px] pb-10 text-[#003A3A] ' >Nyheter</h1>
        <div className=' grid  grid-cols-1 md:grid-cols-2 xl:grid-cols-3  xl:px-[177px] lg:gap-28  items-center px-5'>
          <div className=' md:w-[350px]'>
            ...
            <h2 className=' text-xl  md:text-[32px] font-bold text-[#00354E] leading-[38px] mt-3'>Optimerade miljöer för ett hållbart liv</h2>
      ...
      <div className='hidden md:block'>
        <div className='relative h-[637px] w-full '>
          ...
          <div className='absolute inset-0 w-full  flex flex-row  items-center align-middle lg:gap-5 justify-center p-5'>
            <div className=' relative lg:w-[910px] text-white lg:flex lg:flex-col lg:gap-3'>
              ...
              <h1 className=' text-4xl font-bold py-1'>Egestam & Mattsson satsar på en hållbar affär</h1>
              <div className='flex flex-row lg:flex-col gap-3  '>
                <div className=''>
                  <p className='  md:text-2xl lg:text-[32px] font-normal '>Hållbar framtid en del ev vår affär vår policy för att bidra till de Globala Målen</p>
              ...
              <div className='hidden lg:flex lg:ustify-center'>
      ...
      <div className='md:hidden'>
        <div className='flex flex-col gap-4 items-center mx-5'>
